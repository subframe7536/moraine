...
{ kind: 'switch', prop: 'isMobile', label: 'Mobile layout', defaultValue: false },
{ kind: 'input', prop: 'scrollThreshold', label: 'Scroll threshold', defaultValue: 0, inputType: 'number' },
]}/>
