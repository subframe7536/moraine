...
export function FrameRender() {
  ...
  return (
    <div class="border border-border/70 bg-background flex flex-col h-[400px] w-full shadow-xs overflow-hidden rounded-xl">
      ...
      <header class="px-4 border-b border-border/70 bg-card/70 flex shrink-0 h-11 items-center justify-between">
        <div class="flex gap-3 items-center">
          <div class="font-bold flex gap-2 items-center text-xs">
            <div class="text-white bg-blue-600 flex size-6 items-center justify-center rounded-md">
          ...
          <button class="text-muted-foreground font-medium px-2 py-1 bg-muted/50 flex gap-1.5 transition-colors items-center text-xs rounded-md hover:text-foreground hover:bg-muted">
      ...
      <SidebarFrame isMobile={false} class="flex-1 h-auto min-h-0">
        ...
        <SidebarFrame.Main class="p-4 overflow-y-auto space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="font-bold text-sm">Active Kubernetes Clusters</h3>
          ...
          <div class="gap-3 grid grid-cols-3">
            <div class="p-2.5 border border-border/60 bg-card/60 rounded-lg">
              ...
              <div class="font-bold mt-0.5 text-base">74%</div>
            ...
            <div class="p-2.5 border border-border/60 bg-card/60 rounded-lg">
              ...
              <div class="font-bold mt-0.5 text-base">61%</div>
              <div class="mt-2 rounded-full bg-muted h-1.5 w-full overflow-hidden">
            ...
            <div class="p-2.5 border border-border/60 bg-card/60 rounded-lg">
              ...
              <div class="font-bold mt-0.5 text-base">1.4 Gbps</div>
              <div class="mt-2 rounded-full bg-muted h-1.5 w-full overflow-hidden">
          ...
          <div class="border border-border/60 bg-card/50 overflow-hidden rounded-lg">
