  ...
  const checkoutSteps = [
    {
      ...
      value: 'address',
      content: <p class="text-foreground text-sm">Collect shipping address details.</p>,
    },
    {
      title: 'Shipping',
      ...
      icon: 'i-lucide:truck',
      value: 'shipping',
      content: <p class="text-foreground text-sm">Pick standard, express, or local pickup.</p>,
    },
    {
      title: 'Payment',
      ...
      value: 'payment',
      content: <p class="text-foreground text-sm">Review billing details and submit payment.</p>,
    },
  ]
