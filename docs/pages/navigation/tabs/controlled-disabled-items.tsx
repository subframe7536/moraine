        ...
        items={[
          {
            label: 'Overview',
            value: 'overview',
            render: <p class="text-sm text-foreground">Overview section with release status.</p>,
          },
          {
            label: 'Settings',
            value: 'settings',
          ...
          },
          {
            ...
            value: 'billing',
            disabled: true,
            render: <p class="text-sm text-foreground">This panel is intentionally disabled.</p>,
          },
        ]}
      />
