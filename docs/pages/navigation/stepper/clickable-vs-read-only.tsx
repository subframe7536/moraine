  ...
  const createCheckoutSteps = () => [
    {
      ...
      value: 'address',
      renderContent: <p class="text-sm text-foreground">Collect shipping address details.</p>,
    },
    {
      title: 'Shipping',
      ...
      value: 'shipping',
      renderContent: (
        <p class="text-sm text-foreground">Pick standard, express, or local pickup.</p>
      ),
    },
    {
      title: 'Payment',
      ...
      value: 'payment',
      renderContent: (
        <p class="text-sm text-foreground">Review billing details and submit payment.</p>
      ),
    },
  ]
