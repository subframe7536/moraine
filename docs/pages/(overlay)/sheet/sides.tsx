...
export function Sides() {
  return (
    <div class="flex flex-wrap gap-3 items-center">
      ...
      >
        {(props) => (
          <Button {...props} variant="outline" size="sm" leading="i-lucide:panel-left">
            Left (Navigation)
          </Button>
        )}
      </Sheet>
      ...
      >
        {(props) => (
          <Button {...props} variant="outline" size="sm" leading="i-lucide:shopping-cart">
            Right (Cart Drawer)
          </Button>
        )}
      </Sheet>
      ...
      >
        {(props) => (
          <Button {...props} variant="outline" size="sm" leading="i-lucide:share-2">
            Bottom (Share)
          </Button>
        )}
      </Sheet>
