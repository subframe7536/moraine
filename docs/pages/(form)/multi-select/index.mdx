...
- **Separate limits**: `maxCount` limits total selections; `maxTagCount` collapses visual tags into a `+N` badge.
...
visual: surplus selections stay committed and are summarized in a `+N` badge.
