...
export function HeroSpecimen() {
  ...
  return (
    ...
    >
      <Card.Header>
        <Card.Title>Deployment configurator</Card.Title>
        <Card.Description>Fine-grained reactive workbench</Card.Description>
        <Card.Action>
        ...
        >
          ...
          <div class="pt-3 flex flex-wrap gap-2 items-center justify-between">
            <div class="flex gap-2 items-center">
              <Button type="submit" size="sm" loading={deploying()} leading="i-lucide:rocket">
                Deploy service
              </Button>
