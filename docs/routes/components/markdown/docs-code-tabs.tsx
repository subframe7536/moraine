...
const DOCS_TABS_TRIGGER_CLASS =
  'text-xs px-3 py-1 flex-none z-base rounded-lg text-muted-foreground data-selected:text-foreground data-selected:font-medium hover:not-disabled:text-foreground transition-colors duration-150'
