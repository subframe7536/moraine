...
function DocsPageNavigationCard(props: {
  ...
  return (
    <Button
      ...
      class={cn(
        'group px-4 py-3.5 rounded-lg bg-background gap-3 h-auto min-h-20 w-full transition-([background-color,border-color,transform] duration-180 ease-out) focus-visible:effect-fv hover:(border-primary/40 bg-accent/35) active:translate-y-px motion-reduce:transition-none',
