...
- [x] compare every component with base-ui one-by-one using subagents, sync cross-platform adaption / edge case / keyboard navigation / accessibility / focus management and other missing logic
