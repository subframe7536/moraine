...
export const overlayMenuRecipeOptions = {
  base: {
    ...
    item: 'text-sm px-2 py-1.5 text-foreground outline-none rounded-sm flex gap-2 w-full cursor-default select-none items-center relative data-highlighted:bg-muted data-disabled:opacity-50 data-disabled:pointer-events-none data-expanded:bg-muted data-destructive:text-destructive data-destructive:data-highlighted:bg-destructive/15',
