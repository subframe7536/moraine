...
export const tooltipContentVariants = cva(
  'text-xs px-3 py-1.5 outline-none rounded-md flex gap-1.5 max-w-xs w-fit origin-$mo-popper-content-transform-origin items-center z-floating data-closed:animate-tooltip-out data-expanded:animate-tooltip-in motion-reduce:animate-none',
  {
    variants: {
      side: {
