...
import { MODAL_CONTENT_CLASS, MODAL_OVERLAY_CLASS } from '../modal/modal.recipe'

import type { DialogStyleSlot, DialogStyleVariant } from './dialog.style-types.ts'
...
export const dialogRecipe = /* @__PURE__ */ defineRecipe<
  'dialog',
  DialogStyleSlot,
  DialogStyleVariant
>('dialog', {
