...
export const popoverContentVariants = cva(
  'z-50 relative w-fit max-w-90 origin-$kb-popper-content-transform-origin bg-popover text-popover-foreground flex flex-col gap-2.5 rounded-lg p-2.5 text-sm shadow-md b-(1 foreground/20) outline-none data-expanded:(animate-in fade-in-0 zoom-in-95) data-closed:(animate-out fade-out-0 zoom-out-95) duration-150',
  {
    defaultVariants: {
      side: 'bottom',
    },
