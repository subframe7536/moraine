...
type InputStyleVariant = InputT.Variant & TextControlStyleVariant

export const inputRecipe = /* @__PURE__ */ slotRecipe<InputT.Slot, InputStyleVariant>({
  base: {
    root: `${TEXT_CONTROL_CLASS} [&[type=file]]:text-muted-foreground file:(font-medium me-1.5 outline-none)`,
  },
  defaults: { size: 'md', variant: 'outline', grouped: false },
  variants: {
    size: {
