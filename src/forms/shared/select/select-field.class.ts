...
export const SELECT_FOCUS_VISIBLE_CLASS =
  'focus-visible:(border-ring ring-3 ring-ring/50) focus-visible:data-invalid:(border-destructive ring-destructive/20) dark:focus-visible:data-invalid:(border-destructive/50 ring-destructive/40)'

export const SELECT_FOCUS_SURFACE_BASE_CLASS =
  'pointer-events-none absolute inset-0 rounded-md border border-transparent outline-none'

export const SELECT_FOCUS_SURFACE_CLASS =
  `${SELECT_FOCUS_SURFACE_BASE_CLASS} ${SELECT_FOCUS_VISIBLE_CLASS}`
