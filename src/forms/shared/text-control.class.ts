export interface TextControlStyleVariant {
...
export const TEXT_CONTROL_CLASS =
  'w-full min-w-0 text-foreground bg-transparent outline-none placeholder:text-muted-foreground/70 transition-[colors,box-shadow] disabled:opacity-64 disabled:cursor-not-allowed'
...
export const TEXT_CONTROL_VARIANT = {
  outline: {
    root: 'border border-input bg-transparent shadow-xs dark:bg-input/30',
  },
  subtle: {
    root: 'border border-input bg-input/30 shadow-xs',
  },
  ghost: {
    root: 'hover:bg-muted-hover focus-within:bg-muted-hover',
  },
