...
export const textareaRootVariants = cva(
  'rounded-md inline-flex flex-col w-full transition-[color,box-shadow] overflow-hidden data-focused:effect-fv-border data-invalid:effect-invalid data-disabled:effect-dis data-focused:data-invalid:effect-invalid',
  {
    defaultVariants: {
      size: 'md',
      variant: 'outline',
