...
export const selectRecipeOptions = {
  base: {
    ...
    content: `${SELECT_CONTENT_CLASS} max-w-[var(--mo-popper-content-available-width)] min-w-[var(--mo-popper-anchor-width)] w-[var(--mo-popper-anchor-width)] data-[side=bottom]:(mt-[var(--mo-popper-content-overflow-padding)] -enter-translate-y-1 -exit-translate-y-1) data-[side=left]:(mr-[var(--mo-popper-content-overflow-padding)] enter-translate-x-1 exit-translate-x-1) data-[side=right]:(ml-[var(--mo-popper-content-overflow-padding)] -enter-translate-x-1 -exit-translate-x-1) data-[side=top]:(mb-[var(--mo-popper-content-overflow-padding)] enter-translate-y-1 exit-translate-y-1)`,
    listbox:
    ...
    control:
      'text-foreground outline-none rounded-md flex gap-1.5 w-full transition-[colors,box-shadow] duration-[var(--mo-anim-duration,var(--mo-anim-duration-enter,250ms))] ease-[cubic-bezier(0.16,1,0.3,1)] items-center data-invalid:(border-destructive ring-3 ring-destructive/20) data-disabled:(opacity-64 pointer-events-none) focus-visible:ring-3 dark:data-invalid:(border-destructive/50 ring-destructive/40) data-search:focus-within:data-invalid:(border-destructive ring-3 ring-destructive/20) data-search:dark:focus-within:data-invalid:(border-destructive/50 ring-destructive/40) data-[mode=multi]:px-1.5 [&:not([data-search])]:focus-visible:(outline-none border-ring ring-3 ring-ring/50 data-invalid:border-destructive data-invalid:ring-3 data-invalid:ring-destructive/20) [&:not([data-search])]:dark:focus-visible:data-invalid:(border-destructive/50 ring-destructive/40) [&:not([data-search])]:cursor-pointer data-search:cursor-text data-search:focus-within:(outline-none border-ring ring-3 ring-ring/50)',
    input:
      'text-start outline-none bg-transparent flex-1 min-w-0 w-full truncate data-placeholder:text-muted-foreground disabled:(opacity-64 pointer-events-none) read-only:cursor-pointer data-[mode=multi]:(leading-tight px-0.5 py-0.5 min-w-12) data-[mode=single]:py-1.5',
...
export const multiSelectRecipeOptions = {
  base: {
    ...
    label: 'text-xs text-muted-foreground font-medium px-2 py-1.5 block',
    control:
      'text-foreground px-1.5 outline-none rounded-md flex gap-1.5 w-full transition-[colors,box-shadow] duration-[var(--mo-anim-duration,var(--mo-anim-duration-enter,250ms))] ease-[cubic-bezier(0.16,1,0.3,1)] items-center data-invalid:(border-destructive ring-3 ring-destructive/20) data-disabled:(opacity-64 pointer-events-none) focus-visible:ring-3 dark:data-invalid:(border-destructive/50 ring-destructive/40) data-search:focus-within:data-invalid:(border-destructive ring-3 ring-destructive/20) data-search:dark:focus-within:data-invalid:(border-destructive/50 ring-destructive/40) [&:not([data-search])]:focus-visible:(outline-none border-ring ring-3 ring-ring/50 data-invalid:border-destructive data-invalid:ring-3 data-invalid:ring-destructive/20) [&:not([data-search])]:dark:focus-visible:data-invalid:(border-destructive/50 ring-destructive/40) [&:not([data-search])]:cursor-pointer data-search:cursor-text data-search:focus-within:(outline-none border-ring ring-3 ring-ring/50)',
    input:
