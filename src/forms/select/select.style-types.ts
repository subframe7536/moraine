...
export interface SelectControlStyleSlot<T = unknown> {
  ...
  /** Text presentation of the selected value. */ value?: T
  /** Icon shown before the select input or value. */ leading?: T
  /** Primary interactive button that toggles the popup. */ trigger?: T
  /** Button used to clear the selected value. */ clear?: T
}
