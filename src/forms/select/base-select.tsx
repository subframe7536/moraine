  ...
  function renderVisibleOption(
    ...
    return (
      <div
        ...
        aria-posinset={
          merged.virtualized ? visibleOptionPositionByKey().get(option.key) : undefined
        }
        ...
        class={selectItemVariants({ size: merged.size }, merged.classes?.item, virtualProps?.class)}
        onPointerMove={(event) => {
