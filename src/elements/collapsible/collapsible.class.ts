...
export const COLLAPSIBLE_TRANSITION_CLASS =
  'data-transition:(h-(--mo-collapsible-content-height) overflow-hidden) data-transition:data-expanded:animate-accordion-down data-transition:data-closed:(h-0 animate-accordion-up) data-transition:motion-reduce:animate-none'
